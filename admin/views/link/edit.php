...
<form name='formSort' enctype="multipart/form-data" action="" method="post">
    <table width="100%" bgcolor="#FFFFFF" class="tableList" cellpadding="1" cellspacing="1">
        <tr>
            ...
            <td align="left"><input type="text" name="title" value="<?php echo $link->title?>" size="40" /> <span style="color:#FF0000">*</span></td>
        </tr>
        <tr>
            <td align="right">链接地址</td>
            <td align="left"><input type="text" name="url" value="<?php echo $link->url?>" size="40" /></td>
        </tr>
        <tr>
            <td align="right">链接说明</td>
            <td align="left"><input type="text" name="info" value="<?php echo $link->info?>" size="40" /></td>
        </tr>
        <tr>
