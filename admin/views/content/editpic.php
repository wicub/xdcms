      ...
      <td width="98%"> 
        <table width="100%" bgcolor="#F4FAFB" style="border:1px solid #99d3fb">
          <tr height="30" style="padding:3px 10px;">
            <td width="40%" align="left" height="40"><span style="font-size:16px; font-weight:bold">&nbsp;&nbsp;图片修改</span></td>
            <td width="40%" align="right"><a href="<?php echo site_url('pic/showindex');?>">返回图片浏览</a></td>
          </tr>
        </table>
        <form name='myform' enctype="multipart/form-data" action="<?php echo site_url('pic/updatepic');?>" method="post">
       
       
		 
         <table width="100%" bgcolor="#F4FAFB" class="tableList" cellpadding="1" cellspacing="1">
		 
		 <input style="display:none;" type="text" name="id" value="<?php echo $list->id;?>" />
          <tr id="imgurlid"> 
            <td align="right" height="20">图片<br></td>
            <td height="20"> 
              <input id="imgurlpath" name="imgurl" type="text"  size="45" maxlength="200" readonly="readonly" value="<?php echo $list->imgurl;?>"><font color="#FF0000">*</font> 
          ...
          <tr id="imgurls" height="20"> 
            ...
            <td>
              <img id="imgurlprebrowse" name="" src="<?php echo $list->imgurl;?>" border="0" style="margin:10px 10px;width:300px;height:150px;"/>
            </td>
          </tr>
          ...
          <tr> 
            ...
            <td width="90%"> <input name="title" type="text" size="50" maxlength="200" value="<?php echo $list->title?>">&nbsp;<font color="#FF0000">*</font>长度最大值为100字符</td>
          </tr> 
...
<!---->       
          ...
          <tr> 
            ...
            <td><input name="isrecommend" type="checkbox" value="<?php echo $list->isrecommend;?>" >选择将在推荐图片中显示（需要网站模板支持）</td>
          </tr> 
          <tr> 
          ...
          <tr> 
            ...
            <td><input name="mtime" type="text"  size="20" maxlength="200" value="<?php echo $list->mtime;?>"> <font color="#FF0000">*</font>注意不要改变格式，当前时间为<?php echo date('Y-m-d H:i:s');?></td>
          </tr>
          <tr> 
            <td align="right">更新时间</td>
            <td><input name="ctime" type="text"  size="20" maxlength="200" value="<?php echo $list->ctime;?>"> <font color="#FF0000">*</font>注意不要改变格式，当前时间为<?php echo date('Y-m-d H:i:s');?></td>
          </tr>
          ...
          <tr> 
            ...
            <td>
              <textarea  name="content" style="width:700px;height:300px;"><p>
