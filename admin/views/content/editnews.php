...
<script type="text/javascript" src="<?php echo web_url();?>../kindeditor/kindeditor-min.js"></script>
      ...
      <td width="98%"> 
        <table width="100%" bgcolor="#F4FAFB" style="border:1px solid #99d3fb">
          <tr height="30" style="padding:3px 10px;">
            <td width="40%" align="left" height="40"><span style="font-size:16px; font-weight:bold">&nbsp;&nbsp;新闻修改</span></td>
            <td width="40%" align="right"><a href="<?php echo site_url('news/showindex');?>">返回新闻浏览</a></td>
          </tr>
        </table>
        <form name='myform' enctype="multipart/form-data" action="<?php echo site_url('news/newsupdate');?>" method="post">
        ...
        <input type="text" value="<?php echo $list->id;?>" name="id" style="display:none;" />
         ...
         <table width="100%" bgcolor="#F4FAFB" class="tableList" cellpadding="1" cellspacing="1">
          <tr>
            ...
            <td width="90%"> <input name="title" type="text"  size="50" maxlength="200" value="<?php echo $list->title;?>"> 
...
<!---->
          ...
          <tr> 
            ...
            <td>
              <input name="keywords" type="text"  size="40" maxlength="200" value="<?php echo $list->keywords;?>">用于搜索引擎优化，多个关键词请用用英文版逗号（“,”）隔开
            </td>
          </tr>
          <tr> 
          ...
          <tr> 
            ...
            <td><input name="isrecommend" type="checkbox" value="<?php echo $list->isrecommend;?>" >选择将在推荐文章中显示（需要网站模板支持）</td>
          </tr>
          <tr> 
          ...
          <tr> 
            ...
            <td><input name="author" type="text"  size="10" maxlength="200" value="<?php echo $list->author;?>"> <font color="#FF0000">*</font></td>
          </tr>
          <tr> 
          ...
          <tr> 
            <td height="24" align="right">更新时间</td>
          ...
          <tr> 
            ...
            <td>
              <input  type="text" name="copyfrom" value="<?php echo $list->copyfrom;?>" />&nbsp;&nbsp;&nbsp;&nbsp;
            </td>
          </tr> 
