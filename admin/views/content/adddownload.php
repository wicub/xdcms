      ...
      <td width="98%"> 
        <table width="100%" bgcolor="#F4FAFB" style="border:1px solid #99d3fb">
          <tr height="30" style="padding:3px 10px;">
            <td width="40%" align="left" height="40"><span style="font-size:16px; font-weight:bold">&nbsp;&nbsp;下载添加</span></td>
            <td width="40%" align="right"><a href="<?php echo site_url('down/showindex');?>">返回下载浏览</a></td>
          </tr>
        </table>
        <form name='myform' enctype="multipart/form-data" action="<?php echo site_url('down/downform');?>" method="post">
        
       
         <table width="100%" bgcolor="#F4FAFB" class="tableList" cellpadding="1" cellspacing="1">
          <tr>
            <td align="right" width="10%">文件标题</td>
            <td width="90%"> <input name="title" type="text" size="50" maxlength="200"><font color="#FF0000">*</font></td>
          </tr> 
          <tr> 
          ...
          <tr> 
            ...
            <td> <div style='line-height: 25px;margin:0;width:300px;float:left;overflow: hidden;'><input name="fileurl" id="fileurl" type="text"  size="50" readonly></div>
          ...
          <tr > 
            ...
            <td> <input id="filesizepath" readonly="readonly" name="filesize" type="text" size="10" maxlength="200" value="">K</td>
          </tr> 
<!---->       
          <tr> 
          ...
          <tr> 
           ...
           <tr> 
            ...
            <td><input name="isrecommend" type="checkbox" value="1">选择将在推荐文件中显示（需要网站模板支持）</td>
          </tr> 
          <tr> 
          ...
          <tr> 
            ...
            <td><input name="clicknum" type="text"  size="10" maxlength="200" value=""> <font color="#FF0000">*</font>（点击次数越多，热门信息中排名越靠前）</td>
          </tr>
          <tr> 
...
<!---->
    ...
    &nbsp;&nbsp;默认和系统设置保持一致&nbsp;&nbsp;<a href="<?php echo site_url('index/addtemplate');?>">新模板添加</a></td>
          </tr>
          <tr>
