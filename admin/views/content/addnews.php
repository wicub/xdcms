      ...
      <td width="98%"> 
        <table width="100%" bgcolor="#F4FAFB" style="border:1px solid #99d3fb">
          <tr height="30" style="padding:3px 10px;">
            <td width="40%" align="left" height="40"><span style="font-size:16px; font-weight:bold">&nbsp;&nbsp;新闻添加</span></td>
            <td width="40%" align="right"><a href="<?php echo site_url('news/showindex');?>">返回新闻浏览</a></td>
          </tr>
        </table>
        <form name='myform' enctype="multipart/form-data" action="<?php echo site_url('news/newsform');?>" method="post">
        ...
        <table width="100%" bgcolor="#F4FAFB" class="tableList" cellpadding="1" cellspacing="1">
          ...
          <tr> 
            ...
            <td>
              <input name="keywords" type="text"  size="40" maxlength="200">用于搜索引擎优化，多个关键词请用用英文版逗号（“,”）隔开
            </td>
          </tr>
          <tr> 
          ...
          <tr> 
            ...
            <td><input name="isrecommend" type="checkbox" value="1">选择将在推荐文章中显示（需要网站模板支持）</td>
          </tr>
           <tr> 
            <td align="right">状态</td>
            <td>
              <input name="status" type="radio" value="0" checked="checked">发布
              <input name="status" type="radio" value="1">草稿
            </td>
          </tr>
          <tr> 
          ...
          <tr> 
            ...
            <td><input name="author" type="text"  size="10" maxlength="200" value="admin"> <font color="#FF0000">*</font></td>
          </tr>
          <tr> 
            <td align="right">点击次数</td>
            <td><input name="clicknum" type="text"  size="10" maxlength="200" value="368"> <font color="#FF0000">*</font>（点击次数越多，热门信息中排名越靠前）</td>
          </tr>
          <tr> 
