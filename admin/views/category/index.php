<?php include dirname(__FILE__) . '/../inc/main_top.php'; ?>
        <table width="100%" bgcolor="#F4FAFB" style="border:1px solid #99d3fb">
            <tr height="30" style="padding:3px 10px;">
              <td width="40%" align="left" height="40"><span style="font-size:16px; font-weight:bold">&nbsp;&nbsp;前台栏目管理</span></td>
        ...
        <form name='formSort' enctype="multipart/form-data" action="" method="post">
            <table width="100%" bgcolor="#FFFFFF" class="tableList" cellpadding="1" cellspacing="1" >
              <tr>
                ...
                <td width="35%" align="center">栏目标题</td>
                <td width="7%" align="center">绑定模块</td>
                <td width="10%" align="center">导航位置</td>
              ...
              <tr>
                ...
                <td align="left"><?php echo $str.htmlspecialchars($v->title);?> / <?php echo htmlspecialchars($v->name);?></td>
                <td align="center"><?php echo $modelshow[$v->menumodule]?></td>
                <td align="center"><?php echo $navshow[$v->navshow];?></td>
                <td align="center">
                <?php if($count<2){?>
                    <a href="<?php echo site_url();?>/category/add/<?php echo $v->id?>">添加子栏目</a> | 
                <?}?>
                    <a href="<?php echo site_url();?>/category/edit/<?php echo $v->id?>">编辑</a>
                <?php if($v->id>=100){?>
                     | <a href="<?php echo site_url();?>/category/delete/<?php echo $v->id?>" onclick="return confirm('警告！数据删除，无法恢复，你确定要删除吗？')">删除</a></td>
                <?}?>
              </tr>
            <?php endforeach;?>
