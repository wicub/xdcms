...
K.options = {
	...
	zIndex : 811213,
	items : [
		'justifyleft', 'justifycenter', 'justifyright', 'justifyfull', 'clearhtml', 'forecolor', 'hilitecolor', 'bold',	'italic', 'underline', 'strikethrough', 'removeformat', '|', 'image', 'code', 'source', 'preview', 'fullscreen',
	],
