...
<title>图片中心 - 酷纬企业网站管理系统-企业网站系统-企业建站系统-企业网站程序-企业网站模板 - 酷纬信息--Powered by Kuwebs--Powered by kuwebs.com</title>
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
<meta name="Robots" content="All">
<meta name="googlebot" content="All">
<meta name="keywords" content="成功案例">
<meta name="description" content="网站成功案例">
...
<div class="mainContainer col2-left-layout">
    <div class="col-left aboutListRight"> 
      <div class="commSideNav imgListRightNav">
        <div class="commonSide nav4">
<div class="title nav4"><a href=""><span>图片中心</span></a></div>
<div class="content nav4"><ul class="content nav4"><li class="nav2"><a href="">显示器</a></li><li class="nav2"><a href="">笔记本</a></li><div class="divClear"></div>
</ul><div class="divClear"></div></div>
</div>
        <div class="divBlock blockcn2">
<div class="title blocktcn2">联系我们</div>
<div class="content blockccn2">
	<?php echo $v->content;?>
</div>
</div>      </div>
    </div>
    <div class="col-main imgListMain">
      <h3 class="righttitle"><span class="more"><a href="">首 页</a>&gt;<a href="">图片中心</a></span><span class="titlename">图片中心</span></h3>
      <div class="rightcontent">
        <div class="commonText imgListText">
                    
			<?php foreach($list as $v):?>
			<dl class="blockCon1">
            <dt>
                <a href=""><img src="<?php echo base_url();?>../uploads/<?php echo $v->imgurl;?>" style="width:200px;height:100px;"></a>
            </dt>
              <dd>
                  <span class="title"><a href=""><?php echo $v->title;?></a></span>
              </dd>
              <div class="clear"></div>
			</dl>
			<?php endforeach;?>
        ...
        <div class="commonPaging ImgListPaging">
