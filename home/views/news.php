...
<title>新闻中心 - 酷纬企业网站管理系统-企业网站系统-企业建站系统-企业网站程序-企业网站模板 - 酷纬信息--Powered by Kuwebs--Powered by kuwebs.com</title>
  ...
  <div class="header">
    ...
    <div class="headerShortcuts">
      <ul class="links">
        ...
        <li><a href="javascript:window.external.AddFavorite('')" target="" title="加入收藏">加入收藏</a></li>
        <li class="first"><a href="javascript:;" style="BEHAVIOR: url(#default#homepage)" onclick="this.style.behavior='url(#default#homepage)';this.setHomePage('');return(false);" title="设为首页">设为首页</a></li>
...
<div class="bannerContainer">
  <div class="banner" style="width:950px; height:220px; background:url() left top no-repeat">
    <embed type="application/x-shockwave-flash" wmode="transparent" src="./images/1316188911.swf" height="220" width="950">
  </div>
</div>
...
<div class="mainContainer col2-left-layout">
    <div class="col-left aboutListRight"> 
      <div class="commSideNav aboutListRightNav">
        <div class="commonSide nav2">
<div class="title nav2"><a href=""><span>新闻中心</span></a></div>
<div class="content nav2"><ul class="content nav2"><li class="nav2"><a href="">公司新闻</a></li><li class="nav2"><a href="">行业资讯</a></li><div class="divClear"></div>
...
<div class="content blockccn2"><p>
    ...
    <div class="col-main aboutListMain">
      <h3 class="righttitle"><span class="more"><a href="">首 页</a>&gt;<a href="">新闻中心</a></span><span class="titlename">新闻中心</span></h3>
      <div class="rightcontent">
        <div class="commonText aboutListText">
          <ul>
			<?php foreach($list as $v):?>
            <li>
				<span class="right"><?php echo $v->mtime;?></span>
				<a href="" title="<?php echo $v->title;?>"><?php echo $v->title;?></a>
			</li>
			<?php endforeach;?>	          
			</ul>
        </div>
        <div class="commonPaging newsListPaging">
...
<li class="mainMenu nav9"><a href=""><span>联系我们</span></a></li>
    ...
    <ul class="footerInfo">
      ...
      <li><span style="float:left"><a href="">Powered by Kuwebs V3.0</a></span>电话：0755-36943966 E-mail：<a href="mailto:info@kuwebs.com">info@kuwebs.com</a>联系地址：深圳市福田区上梅林梅华路105号多丽工业区福田国际电子商务产业园2栋502</li>
    </ul>
